...
@section('header')
    <div class="page-header clearfix">
        <h1>
            ...
            <a class="btn btn-success pull-right" href="{{ route('products.create') }}"><i
                ...
                <table class="table table-condensed table-striped">
                    ...
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td class="text-right">
                                <a class="btn btn-xs btn-primary" href="{{ route('products.show', $product->id) }}"><i
                                            class="glyphicon glyphicon-edit"></i> View</a>
                                <a class="btn btn-xs btn-warning" href="{{ route('products.edit', $product->id) }}"><i
